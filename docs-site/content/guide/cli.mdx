...
It reads a grammar file (EBNF or ABNF) and emits a fully typed TypeScript
parser class that extends `RDParser` or `ObservableRDParser`.
...
fields (`target: ES2022`), strict null checks, and the package exports map
