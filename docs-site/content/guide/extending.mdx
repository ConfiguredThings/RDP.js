...
> **Note:** [`rdp-gen`](/docs/cli/) generates this pattern automatically. If you are using the code
...
| `restorePosition(pos)` | Backtracks to a saved position (enables [grammars beyond LL(1)](/docs/concepts/#ll1-grammars-and-backtracking)) |
...
parse tree. It implements the same grammar as the [rdp-gen tutorial](/docs/tutorial/) — see [`RDParserException`](/api/classes/RDParser.RDParserException.html) for the exception type thrown on parse failure.
