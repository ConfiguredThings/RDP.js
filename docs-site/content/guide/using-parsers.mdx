...
`--transformer json` generates ready-to-fill stubs for both directions — see the
...
Scaffold flags emit a typed starter file wired up to your grammar — imports, entry
points, stubs, and error handling already in place. Flags compose: pass multiple to
combine strategies:
...
[CLI reference](/docs/cli/#scaffolding),
